...
export function ItemCategoryList({ }: Props) {
			...
			<Card>
				<Card.Header>
					<div className="d-flex align-items-center justify-content-between mb-0">
						<h2 className="h2 mb-0 ">Famille d'article</h2>
						<Dropdown >
							...
							<Dropdown.Menu>
								<Dropdown.Item href='itemCategory/add'>
					...
					<Table responsive>
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<ButtonGroup size='sm'>
										<Button variant='light' href='itemCategory/1'><AiOutlineEye /></Button>
										<Button variant='light' href='itemCategory/edit/1'><AiOutlineEdit /></Button>
									</ButtonGroup>
								</td>
			...
			<Card>
				...
				<Card.Body>
					<Form>
						...
						<Button variant="outline-secondary" href='/itemCategory'>
...
export function ItemCategoryInfo() {
