			...
			<Card>
				<Card.Header>
					<div className="d-flex align-items-center justify-content-between mb-0">
						<h2 className="h2 mb-0 ">Unité de Vente</h2>
						<Dropdown >
					...
					<Table responsive>
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<ButtonGroup size='sm'>
										<Button variant='light' href='unit/1'><AiOutlineEye /></Button>
										<Button variant='light' href='unit/edit/1'><AiOutlineEdit /></Button>
									</ButtonGroup>
								</td>
			...
			<Card>
				...
				<Card.Body>
					<Form>
						...
						<Button variant="outline-secondary" href='/unit'>
