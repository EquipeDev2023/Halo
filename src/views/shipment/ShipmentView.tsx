			...
			<Card>
				<Card.Header>
					<div className="d-flex align-items-center justify-content-between mb-0">
						<h2 className="h2 mb-0 ">Expédition</h2>
						<Dropdown >
					...
					<Table responsive>
						...
						<tbody>
							...
							<tr>
								...
								<td className="align-middle"><Badge bg="primary">Livraison</Badge></td>
								<td className="align-middle">10/10/2023</td>
								<td className="align-middle"><Badge bg="success">En attente</Badge></td>
								<td>
									<ButtonGroup size='sm'>
										<Button variant='light' href='shipment/1'><AiOutlineEye /></Button>
										<Button variant='light' href='shipment/edit/1'><AiOutlineEdit /></Button>
									</ButtonGroup>
								</td>
			...
			<Card>
				...
				<Card.Body>
					<Form>
						...
						<Button variant="outline-secondary" href='/shipment'>
